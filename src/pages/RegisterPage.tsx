    ...
    <div className="min-h-dvh flex flex-col justify-between px-6 py-10 page-enter">
      ...
      <div className="flex-1 flex flex-col justify-center">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="font-display text-3xl font-bold text-ink-50 tracking-tight">Регистрация</h1>
          <p className="text-ink-400 text-sm mt-1">Начни путь к гранту</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-xs font-medium text-ink-400 uppercase tracking-wider mb-1.5 block">Имя</label>
            <input
              type="text"
              value={name}
